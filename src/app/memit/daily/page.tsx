        ...
        <div className="min-h-screen bg-transparent">
                    ...
                    <div className="mb-8 px-4 flex items-center justify-between">
                        <div>
                            <span className="text-primary font-semibold text-xs uppercase tracking-wider flex items-center gap-2">
                                <Sun className="w-3.5 h-3.5 text-yellow-400" /> MEMIT DAILY
                            </span>
                            <h1 className="text-3xl font-bold text-white font-display mt-1">일상 & 생활</h1>
                            <p className="text-slate-400 mt-1">오늘의 사소한 할 일이나 기억할 내용들을 스토리에 담아 관리하세요.</p>
                        </div>
                    </div>

                    <MemoryGenerator category="daily" onMemorySaved={handleMemorySaved} />
                </div>
            </div>
            ...
            <div className="md:hidden flex flex-col min-h-screen bg-background-dark">
                <header className="flex items-center justify-between px-6 py-5 z-20">
                    ...
                    <h1 className="text-lg font-bold tracking-tight text-center flex-1 text-white">일상 & 생활</h1>
