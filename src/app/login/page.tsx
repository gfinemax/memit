    ...
    return (
        <div className="bg-background-light dark:bg-background-dark text-slate-800 dark:text-slate-100 font-display min-h-screen flex flex-col lg:flex-row overflow-x-hidden">
            ...
            <div className="flex flex-col lg:flex-row w-full min-h-screen relative z-10 shrink-0">
                ...
                {/* Left Side: Cinematic Visual (Mobile Header) */}
                <div className="relative w-full lg:w-[60%] h-[45vh] lg:h-screen overflow-hidden group">
                    {/* Background Image */}
                    <div
                    ...
                    <div className="absolute inset-0 flex flex-col justify-center px-8 lg:px-24 z-10 text-white pt-[env(safe-area-inset-top)]">
                        <div className="max-w-2xl">
                            <div className="w-12 h-1 bg-primary mb-6 lg:mb-8 rounded-full fade-in-text"></div>
                            <h1 className="text-3xl lg:text-6xl font-bold leading-tight mb-4 lg:mb-6 fade-in-text fade-in-delay-1 tracking-tight">
                                당신의 기억은 <br />
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-white to-primary/80">어디에 있나요?</span>
                            </h1>
                            <p className="text-base lg:text-xl text-slate-300 font-light leading-relaxed fade-in-text fade-in-delay-2 border-l-2 border-primary pl-4 lg:pl-6">
                    ...
                    {/* Decorative elements */}
                    <div className="absolute top-10 left-10 opacity-50 fade-in-text pt-[env(safe-area-inset-top)]">
                ...
                <div className="relative w-full lg:w-[40%] flex flex-col justify-start lg:justify-center items-center flex-1 bg-background-dark overflow-visible">
                    ...
                    <div className="w-full max-w-md px-6 z-10 -mt-12 lg:mt-0 mb-10">
                        ...
                        {/* Glass Card */}
                        <div className="glass-panel p-6 lg:p-8 rounded-2xl floating-element relative overflow-hidden shadow-2xl backdrop-blur-xl border border-white/10">
                            ...
                            <form className="space-y-5">
                                <div className="space-y-1">
                                    ...
                                    <div className="relative group">
                                        ...
                                        <input
                                            className="block w-full pl-10 pr-3 py-2.5 lg:py-3 bg-background-dark/50 border border-slate-700 rounded-lg text-slate-200 placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300 text-sm lg:text-base"
                                            id="email"
                                ...
                                >
                                    ...
                                    <div className="relative px-6 py-3 bg-background-dark rounded-lg group-hover:bg-opacity-0 transition-all duration-300 ease-out">
                                        <span className="relative flex items-center justify-center gap-2 text-white font-semibold tracking-wide group-hover:scale-105 transition-transform text-sm lg:text-base">
                                            Guest Login (Demo)
                    ...
                    {/* Scroll Guide (Relocated) */}
                    <div className="mt-8 lg:mt-12 flex flex-col items-center gap-6 pb-20 lg:pb-8 opacity-80 lg:opacity-100">
                        {/* Scroll Guide (Bouncing) */}
                        <div
                            className="text-center cursor-pointer opacity-80 hover:opacity-100 transition-opacity animate-bounce"
                        ...
                        {/* Footer Info (Static) */}
                        <p className="text-[10px] text-white/40 font-light tracking-wider">
