        ...
        <div className="min-h-screen bg-transparent">
                    ...
                    <div className="mb-8 px-4 flex items-center justify-between">
                        <div>
                            <span className="text-primary font-semibold text-xs uppercase tracking-wider flex items-center gap-2">
                                <Mic className="w-3.5 h-3.5 text-orange-400" /> MEMIT SPEECH
                            </span>
                            <h1 className="text-3xl font-bold text-white font-display mt-1">발표 & 스피치</h1>
                            <p className="text-slate-400 mt-1">긴 발표 원고를 다 외울 필요 없습니다. 핵심 키워드를 이야기로 연결하여 막힘없이 스피치하세요.</p>
                        </div>
                    </div>

                    <MemoryGenerator category="speech" onMemorySaved={handleMemorySaved} />
                </div>
            </div>
            ...
            <div className="md:hidden flex flex-col min-h-screen bg-background-dark">
                <header className="flex items-center justify-between px-6 py-5 z-20">
                    ...
                    <h1 className="text-lg font-bold tracking-tight text-center flex-1 text-white">발표 & 스피치</h1>
