                    ...
                    <div className="mb-8 px-4 flex items-center justify-between">
                        <div>
                            <span className="text-primary font-semibold text-xs uppercase tracking-wider flex items-center gap-2">
                                <Shield className="w-3.5 h-3.5" /> MEMIT SECURITY
                            </span>
                            <h1 className="text-3xl font-bold text-white font-display mt-1">보안 & 금융</h1>
                            <p className="text-slate-400 mt-1">민감한 암호나 카드 정보를 강력한 시각적 스토리로 안전하게 보호하세요.</p>
                        </div>
                    </div>

                    <MemoryGenerator category="security" onMemorySaved={handleMemorySaved} />
                </div>
            </div>
